...
export const jwtConfig = registerAs("jwt", () => {
    ...
    const jwtRefresh: ISingleJwt = {
        ...
        time: Number(process.env.JWT_REFRESH_TOKEN_EXPIRED) || DEFAULT_TOKEN_EXPIRED,
    };
    ...
    const jwtResetPassword: ISingleJwt = {
        ...
        time: Number(process.env.JWT_RESET_PASSWORD_EXPIRED) || DEFAULT_TOKEN_EXPIRED,
    }


    return {
        [TokenTypeEnum.ACCESS]: jwtAccess,
        [TokenTypeEnum.REFRESH]: jwtRefresh,
        [TokenTypeEnum.CONFIRMATION]: jwtConfirmation,
        [TokenTypeEnum.RESET_PASSWORD]: jwtResetPassword,
