import { SLUG_REGEX } from '@app/shared/constants';
import { Account } from '@app/shared/entities';
import { isNil } from '@app/shared/utils';
import { EntityManager, EntityRepository, FilterQuery, RequiredEntityData } from '@mikro-orm/postgresql';
import {
  BadRequestException,
  Injectable,
