        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex-1 truncate text-sm font-medium text-text-strong-950">
                {title}
              </div>
              <RiArrowDownSLine
                className={cn(
          ...
          >
            ...
            >
              <ToggleGroupItem
                value="sales"
                className="flex h-6 items-center justify-center rounded-md text-center text-xs text-muted-foreground transition duration-200 ease-out data-[state=on]:bg-accent data-[state=on]:text-primary"
              >
                Sales
              </ToggleGroupItem>
              <ToggleGroupItem
